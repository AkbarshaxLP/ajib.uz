  ...
  <main class="category-page">
    <div class="container">
      ...
      <p v-else-if="!pending" class="empty-state">
        Hozircha bu turdagi telefonlar yo'q
      </p>
    </div>
  </main>
</template>
...
const TYPE_TITLES: Record<string, string> = {
  ...
  push_button: 'Tugmali telefonlar',
}

const title = computed(() => TYPE_TITLES[props.type] ?? props.type)
...
const phones = computed<any[]>(() => {
  ...
  return all.filter((p) => p.phone_type === props.type)
})
